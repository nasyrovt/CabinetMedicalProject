...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/">
        <patient xmlns="http://www.ujf-grenoble.fr/l3miage/patient" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.ujf-grenoble.fr/l3miage/patient ../xsd/patient.xsd">
